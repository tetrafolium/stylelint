...
testRule({
  ...
  reject : [
    ...
    },
    {
      ...
      message : messages.expected('unix'),
      description :
          'CRLF inside a comment string without spaces in the beginning in the first line',
      line : 1,
      column : 12,
    },
    {
...
testRule({
  ...
  reject : [
    ...
    },
    {
      ...
      message : messages.expected('windows'),
      description :
          'LF inside a comment string without spaces in the beginning in the first line',
      line : 1,
      column : 12,
    },
    {
