...
const isStandardSyntaxDeclaration =
    require('../../utils/isStandardSyntaxDeclaration');
...
function rule(expectation, options, context) {
  return (root, result) => {
    const validOptions = validateOptions(
        ...
        },
        {
          ...
          possible : {
                ...
                [ 'first-nested', 'after-comment', 'after-custom-property' ],
            ignore :
                [ 'after-comment', 'first-nested', 'inside-single-line-block' ],
          },
          optional : true,
        },
    );
    ...
    root.walkDecls((decl) => {
      ...
      if (optionsMatches(options, 'ignore', 'inside-single-line-block') &&
