...
const isAfterSingleLineComment =
    require('../../utils/isAfterSingleLineComment');
...
function rule(expectation, options, context) {
  return (root, result) => {
    ...
    root.walkRules((rule) => {
      ...
      if (optionsMatches(options, 'ignore', 'after-comment') && rule.prev() &&
      ...
      if (expectation.includes('multi-line') &&
