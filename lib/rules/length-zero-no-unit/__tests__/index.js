...
testRule({
  ...
  accept : [
    ...
    },
    {
      ...
      description :
          'ignore line-height in font declaration within var function',
    },
    {
...
testRule({
  ...
  reject : [
    ...
    {
      code :
          '@detached-ruleset: { grid-template-columns: 0fr; font-size: 0px; line-height: 0px; };',
      fixed :
          '@detached-ruleset: { grid-template-columns: 0fr; font-size: 0; line-height: 0px; };',
