...
function isStandardDirection(source, withToPrefix) {
  const regexp =
      withToPrefix ? /^to (top|left|bottom|right)(?: (top|left|bottom|right))?$/
      ...
      valueParser(decl.value).walk((valueNode) => {
        ...
        functionArgumentsSearch(
            ...
            (expression, expressionIndex) => {
              ...
              // If the first character is a number, we can assume the user
              // intends an angle
              ...
              // or a color stop (in which case user gets default direction, "to
              // bottom") cf.
              ...
              function complain() {
                report({
                  ...
                  node : decl,
                  index : declarationValueIndex(decl) + valueNode.sourceIndex +
                              expressionIndex,
                  result,
                  ruleName,
                });
