    ...
    function check(node, value, getIndex) {
      ...
      valueParser(value).walk((valueNode) => {
        ...
        if (expectation === 'always') {
          ...
          // The regexp above consists of 2 capturing groups (or capturing
          // parentheses). We need the index of the second group. This makes
          // sanse when we have "-.5" as an input for regex. And we need the
          // index of ".5".
        ...
        if (expectation === 'never') {
          ...
          // The regexp above consists of 3 capturing groups (or capturing
          // parentheses). We need the index of the second group. This makes
          // sanse when we have "-00.5" as an input for regex. And we need the
          // index of "00".
