 ...
 * @param {Document|null} document the document node with `postcss-html` and
 *     `postcss-jsx`.
...
function isEofNode(document, root) {
  ...
  // In the `postcss-html` and `postcss-jsx` syntax, checks that there is text
