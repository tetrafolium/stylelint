...
it('findFontFamily', () => {
  ...
  expect(findFontFamily('italic  bold  12px  /  30px  Georgia,  serif'))
      .toEqual([
        {
          sourceIndex : 29,
          type : 'word',
  ...
  expect(findFontFamily('italic bold 12px/30px "Red/Black", Arial, sans-serif'))
      .toEqual([
        {
          quote : '"',
          sourceIndex : 22,
  ...
  expect(findFontFamily('italic bold 12px/30px Arial, "Ahem!", sans-serif'))
      .toEqual([
        {
          sourceIndex : 22,
          type : 'word',
