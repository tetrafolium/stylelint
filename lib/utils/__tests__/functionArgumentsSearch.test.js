...
it('passes function arguments to callback', () => {
  functionArgumentsSearch('calc(1 + 3)', 'calc',
                          (expression, expressionIndex) => {
                            expect(expression).toBe('1 + 3');
                            expect(expressionIndex).toBe(5);
                          });
  functionArgumentsSearch('4px 5px calc(1px + 3px)', 'calc',
                          (expression, expressionIndex) => {
...
it('works with nested functions', () => {
  ...
  functionArgumentsSearch(colorFuncValue, 'color',
                          (expression, expressionIndex) => {
  ...
  functionArgumentsSearch(colorFuncValue, 's',
                          (expression, expressionIndex) => {
...
it('ignores strings', () => {
  functionArgumentsSearch('calc(1px)', 'calc',
                          (expression, expressionIndex) => {
