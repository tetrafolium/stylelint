...
describe('isStandardSyntaxSelector', () => {
  it('type', () => { expect(isStandardSyntaxSelector('a')).toBeTruthy(); });
  it('class', () => { expect(isStandardSyntaxSelector('.a')).toBeTruthy(); });
  it('attribute',
  ...
  it('complex',
     () => { expect(isStandardSyntaxSelector('a > b')).toBeTruthy(); });
  it('list', () => { expect(isStandardSyntaxSelector('a, b')).toBeTruthy(); });
