...
it('findListStyleType', () => {
  ...
  expect(findListStyleType("url('sqpurple.gif') custom-counter-style outside"))
      .toEqual([
        {
          sourceIndex : 20,
          type : 'word',
  ...
  expect(findListStyleType("custom-counter-style url('sqpurple.gif') outside"))
      .toEqual([
        {
          sourceIndex : 0,
          type : 'word',
  ...
  expect(findListStyleType("url('sqpurple.gif') outside custom-counter-style"))
      .toEqual([
        {
          sourceIndex : 28,
          type : 'word',
