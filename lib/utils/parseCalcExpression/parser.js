 ...
 * immediately preceeding the current look-ahead token. Caveats apply for rules
...
var parser = (function() {
  ...
  function JisonParserError(msg, hash) {
    ...
    Object.defineProperty(this, 'message',
                          {enumerable : false, writable : true, value : msg});
  ...
  var parser = {
    ...
    collect_expected_token_set : function parser_collect_expected_token_set(
      ...
      for (var p in this.table[state]) {
        ...
        if (p !== TERROR) {
          ...
          if (d && !check[d]) {
            tokenset.push(d);
            check[d] = true; // Mark this token description as already mentioned
                             // to prevent outputting duplicate entries.
          }
        }
      }
      return tokenset;
    ...
    performAction : function parser__PerformAction(
        yyloc, yystate /* action[1] */, yysp, yyvstack, yylstack) {
      /* this == yyval */
      ...
      case 3:
        /*! Production::    math_expression : math_expression ADD
         * math_expression */
      case 4:
        /*! Production::    math_expression : math_expression SUB
         * math_expression */
      case 5:
        /*! Production::    math_expression : math_expression MUL
         * math_expression */
      case 6:
        /*! Production::    math_expression : math_expression DIV
         * math_expression */
        ...
        this.$ = {
          ...
          source : {
            ...
            operator : {
              start : {index : yylstack[yysp - 1].range[0]},
              end : {index : yylstack[yysp - 1].range[1]}
            }
          }
        };
        break;
      ...
      case 7:
        ...
        this.$ = yyvstack[yysp];
        this.$.sign = '-' this.$.value = -yyvstack[yysp].value;
      ...
      case 8:
        ...
        this.$ = yyvstack[yysp];
        this.$.sign = '+' this.$.source.start.index =
            yylstack[yysp - 1].range[0];
        break;
      ...
      case 13:
        ...
        this.$ = {
          ...
          source : {
            start : {index : yylstack[yysp].range[0]},
            end : {index : yylstack[yysp].range[1]}
          }
        };
        break;
    ...
    table : bt({
      len : u([
        18, 1, 5, 1, s, [ 17, 3 ], s, [ 0, 13 ], s, [ 17, 5 ], 0, 0, 5, 6, 6, c,
        [ 5, 3 ], 0, 0
      ]),
      symbol : u([
        3,           4, 6, 7,          s, [ 10, 14, 1 ], 1, 1,           s,
        [ 6, 4, 1 ], 4, c, [ 25, 13 ], c, [ 24, 4 ],     c, [ 17, 119 ], s,
        [ 5, 5, 1 ], 1, c, [ 6, 11 ],  c, [ 5, 5 ]
      ]),
      type : u([
        s, [ 2, 13 ], s, [ 0, 5 ], 1, s, [ 2, 19 ], s, [ 0, 4 ], c, [ 17, 132 ],
        s, [ 2, 9 ]
      ]),
      state : u([
        1, 2,        9,  7, 8,        25, c, [ 4, 3 ], 26, c, [ 4, 3 ], 27,
        c, [ 4, 3 ], 28, c, [ 4, 3 ], 29, c, [ 4, 3 ], 30, c, [ 4, 3 ], 31,
        c, [ 4, 3 ], 32, c, [ 4, 3 ]
      ]),
      mode : u([ s, [ 1, 128 ], s, [ 2, 4 ], c, [ 6, 8 ], s, [ 1, 5 ] ]),
      goto : u([
        3,  6,          5, 4,          18, s,  [ 10, 8, 1 ], s, [ 19, 6, 1 ],
        c,  [ 19, 13 ], c, [ 13, 91 ], 33, c,  [ 110, 4 ],   s, [ 3, 4 ],
        22, 23,         s, [ 4, 4 ],   22, 23, 34,           c, [ 17, 4 ]
      ])
    }),
    defaultActions : bda({
    ...
    parse : function parse(input) {
      ...
      var NO_ACTION = [
        0, 35 /* === table.length :: ensures that anyone using this new state
      ...
      this.yyGetSharedState =
          function yyGetSharedState() { return sharedState_yy; };
      ...
      if (typeof sharedState_yy.parseError === 'function') {
        this.parseError = function parseErrorAlt(str, hash, ExceptionClass) {
          ...
          return sharedState_yy.parseError.call(this, str, hash,
                                                ExceptionClass);
        };
      } else {
      ...
      if (typeof sharedState_yy.quoteName === 'function') {
        this.quoteName = function quoteNameAlt(
            id_str) { return sharedState_yy.quoteName.call(this, id_str); };
      } else {
      ...
      this.cleanupAfterParse = function parser_cleanupAfterParse(
        ...
        if (invoke_post_methods) {
          ...
          if (sharedState_yy.post_parse) {
            rv = sharedState_yy.post_parse.call(this, sharedState_yy,
                                                resultValue, hash);
        ...
        if (this.__reentrant_call_depth > 1)
          return resultValue; // do not (yet) kill the sharedState when this is
                              // a reentrant run.
      ...
      //
      // `first_index` and `last_index` MAY be UNDEFINED/NULL or these are
      // indexes into the `lstack[]` location stack array.
      //
      // `first_yylloc` and `last_yylloc` MAY be UNDEFINED/NULL or explicit
      // (custom or regular) `yylloc` instances, in which case these override
      // the corresponding first/last indexes.
      //
      // `dont_look_back` is an optional flag (default: FALSE), which instructs
      // this merge operation NOT to search through the parse location stack for
      // a location, which would otherwise be used to construct the new
      // (epsilon!) yylloc info.
      //
      // Note: epsilon rule's yylloc situation is detected by passing both
      // `first_index` and `first_yylloc` as UNDEFINED/NULL.
      this.yyMergeLocationInfo = function parser_yyMergeLocationInfo(
          first_index, last_index, first_yylloc, last_yylloc, dont_look_back) {
        var i1 = first_index | 0, i2 = last_index | 0;
        var l1 = first_yylloc, l2 = last_yylloc;
        var rv;
        ...
        if (!l1 && first_index == null) {
          ...
          if (!l1) {
            if (!l2) {
              // when we still don't have any valid yylloc info, we're looking
              // at an epsilon rule without look-ahead and no preceding terms
              // and/or `dont_look_back` set: in that case we ca do nothing but
              ...
              rv = shallow_copy(l2);
              if (rv.range) {
                // shallow copy the yylloc ranges info to prevent us from
        ...
        // shallow-copy L1|L2, before we try to adjust the yylloc values: after
        // all, we MAY be looking at unconventional yylloc info objects...
        rv = shallow_copy(l1);
        ...
        // last_column: ...,
        if (rv.range) {
          // shallow copy the yylloc ranges info to prevent us from modifying
          // the original arguments' entries:
          rv.range = rv.range.slice(0);
        }
      ...
      var yyval = {$ : true, _$ : undefined, yy : sharedState_yy};
      var p;
      var yyrulelen;
      var this_production;
      var newState;
      ...
      try {
        ...
        for (;;) {
          ...
          default:
            ...
            // Another case of better safe than sorry: in case state transitions
            // come out of another error recovery process or a buggy LUT (LookUp
            // Table):
            p = this.constructParseErrorInfo(
          ...
          case 2:
            ...
            this_production =
                this.productions_[newState -
                                  1]; // `this.productions_[]` is zero-based
                                      // indexed while states start from 1
                                      // upwards...
            yyrulelen = this_production[1];

            r = this.performAction.call(yyval, yyloc, newState, sp - 1, vstack,
                                        lstack);
          ...
          case 3:
            if (sp !== -2) {
              ...
              // the <startSymbol> rule as the parse result, IFF that result is
              ...
              //                  %{
              //                      @$ = @1;            // if location
              //                      tracking support is included if (typeof $1
              //                      !== 'undefined')
              //                          return $1;
              //                      else
              //                          return true;           // the default
              //                          parse result if the rule actions don't
              //                          produce anything
              //                  %}
              sp--;
        ...
        if (ex instanceof this.JisonParserError) {
          throw ex;
        } else if (lexer && typeof lexer.JisonLexerError === 'function' &&
                   ex instanceof lexer.JisonLexerError) {
          throw ex;
        }

        p = this.constructParseErrorInfo('Parsing aborted due to exception.',
                                         ex, null, false);
        retval = false;
        r = this.parseError(p.errStr, p, this.JisonParserError);
        if (typeof r !== 'undefined') {
   ...
   *                               `yy_` is an alias for `this` lexer instance
  ...
  var lexer = function() {
    ...
    var lexer = {
      ...
      __error_infos : [], /// INTERNAL USE ONLY: the set of lexErrorInfo objects
                          /// created since the last cleanup
      __decompressed :
          false, /// INTERNAL USE ONLY: mark whether the lexer instance has been
                 /// 'unfolded' completely and is now ready for use
      ...
      parseError : function lexer_parseError(str, hash, ExceptionClass) {
        ...
        if (this.yy) {
          if (this.yy.parser &&
            ...
            return this.yy.parser.parseError.call(this, str, hash,
                                                  ExceptionClass) ||
                   this.ERROR;
      ...
      setInput : function lexer_setInput(input, yy) {
        ...
        if (!this.__decompressed) {
          ...
          for (var k in conditions) {
            ...
            var rule_regexes = new Array(
                len +
                1); // slot 0 is unused; we use a 1-based index approach here to
                    // keep the hottest code in `lexer_next()` fast and simple!
       ...
       * @this {RegExpLexer}
       */
      deriveLocationInfo : function lexer_deriveYYLLOC(actual, preceding,
                                                       following, current) {
        var loc = {
          first_line : 1,
          first_column : 0,
       ...
       * @this {RegExpLexer}
       */
      prettyPrintRange : function lexer_prettyPrintRange(loc, context_loc,
                                                         context_loc2) {
        ...
        var l0 = Math.max(1, (context_loc ? context_loc.first_line
                                          : loc.first_line - CONTEXT));
        var l1 = Math.max(1, (context_loc2 ? context_loc2.last_line
            ...
            lines.slice(l0 - 1, l1 + 1)
                .map(function injectLineNumber(line, index) {
                  ...
                  if (lno === loc.first_line) {
                    ...
                    len = Math.max(2, ((lno === loc.last_line ? loc.last_column
                                                              : line.length)) -
                                          loc.first_column + 1);
        ...
        if (nonempty_line_indexes.length >
            2 * MINIMUM_VISIBLE_NONEMPTY_LINE_COUNT) {
          var clip_start =
              nonempty_line_indexes[MINIMUM_VISIBLE_NONEMPTY_LINE_COUNT - 1] +
              1;
          var clip_end =
              nonempty_line_indexes[nonempty_line_indexes.length -
       ...
       * @this {RegExpLexer}
       */
      describeYYLLOC : function lexer_describe_yylloc(yylloc,
                                                      display_range_too) {
       ...
       * @this {RegExpLexer}
       */
      begin : function lexer_begin(
          condition) { return this.pushState(condition); },
       ...
       */
      stateStackSize : function
          lexer_stateStackSize() { return this.conditionStack.length; },
