...
/**
 * Return the cacheFile to be used by stylelint, based on whether the provided
 * parameter is a directory or looks like a directory (ends in `path.sep`), in
 * which case the file name will be `cacheFile/.cache_hashOfCWD`.
 *
 * If cacheFile points to a file or looks like a file, then it will just use
 * that file.
 *
