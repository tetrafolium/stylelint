...
module.exports = function(options, callback) {
  ...
  if (!callback)
    throw new Error('checkAgainstRule requires a callback');
  ...
  const settings =
      normalizeRuleSettings(options.ruleSettings, options.ruleName);
  ...
  rules[options.ruleName](settings[0], settings[1], {})(options.root,
                                                        tmpPostcssResult);
