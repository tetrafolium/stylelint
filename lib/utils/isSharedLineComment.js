...
const getNextNonSharedLineCommentNode =
    require('./getNextNonSharedLineCommentNode');
...
module.exports = function isSharedLineComment(node) {
  ...
  if (nextNonSharedLineCommentNode &&
  ...
  if (parentNode !== undefined && parentNode.type !== 'root' &&
      parentNode.index(node) === 0 && node.raws.before !== undefined &&
