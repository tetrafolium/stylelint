 ...
 * @param {{[k: string]: string|Function}} messages - Object whose keys are
 *     message identifiers
 *   and values are either message strings or functions that return message
 * strings
 * @return {{[k: string]: string|Function}} New message object, whose messages
 *     will be marked with the rule name
 */
