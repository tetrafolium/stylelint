...
/**
 * @typedef {import('file-entry-cache').FileDescriptor["meta"] & {
 * hashOfConfig?: string }} CacheMetadata
 */
 ...
 */
class FileCache {
  constructor(cacheLocation = DEFAULT_CACHE_LOCATION,
  ...
  reconcile() { this._fileCache.reconcile(); }

  destroy() { this._fileCache.destroy(); }
