 ...
 * @param {boolean} [primaryOptionArray] If primaryOptionArray is not provided,
 *     we try to get it from the, rules themselves, which will not work for
 *     plugins
...
module.exports = function(
  ...
  if (rawSettings.length === 2 && !_.isPlainObject(rawSettings[0]) &&
