...
import {
  ...
  export type StylelintConfigProcessors =
      string|Array<StylelintConfigProcessor>;
  ...
  export type DisabledRange = {
    comment: Comment; start : number; strictStart : boolean;
    end?: number;
    strictEnd?: boolean;
    rules?: string[];
    description?: string;
  ...
  export type DisabledRangeObject = {[ruleName: string]: Array<DisabledRange>;};

  export type DisabledWarning = {line: number; rule : string};

  export type StylelintPostcssResult = {
    ruleSeverities: {[k: string]: any}; customMessages : {[k: string] : any};
    quiet?: boolean; disabledRanges : DisabledRangeObject;
  ...
  type EmptyResult = {
    root: {
      nodes?: undefined; source : {lang?: undefined; input : {file?: string;};};
    };
  ...
  export type FormatterIdentifier =
      |'compact'|'json'|'string'|'tap'|'unix'|'verbose'|Formatter;
  ...
  export type GetLintSourceOptions =
      GetPostcssOptions&{existingPostcssResult?: Result};

  export type StylelintInternalApi = {
    _options: StylelintStandaloneOptions; _extendExplorer : {
  ...
  export type StylelintCssSyntaxError = {
    column: number;
    file?: string;
    input : {column : number; file?: string; line : number; source : string;};
    line : number;
    message : string;
    name : string;
    reason : string;
  ...
  export type StylelintWarning = {
    line: number; column : number; rule : string; severity : string;
    text : string;
    stylelintType?: string;
  };

  export type StylelintResult = {
    source?: string; deprecations : Array<{text : string; reference : string;}>;
    invalidOptionWarnings : Array<{text : string;}>;
    parseErrors : Array<Warning&{stylelintType : string}>;
    errored?: boolean; warnings : Array<StylelintWarning>;
    ignored?: boolean;
    _postcssResult?: PostcssResult;
  };

  export type DisableReportRange = {
    rule: string; start : number;
    end?: number;
  ...
  export type StylelintDisableReportEntry = {
    source?: string; ranges : Array<DisableReportRange>;
  };

  export type StylelintStandaloneReturnValue = {
    results: Array<StylelintResult>; errored : boolean; output : any;
  ...
  export type StylelintPublicAPI = {
    lint: Function; rules : {[k: string] : StylelintRule};
    ...
    utils : {
      report : Function; ruleMessages : Function; validateOptions : Function;
      checkAgainstRule : Function;
    };
  };

  export type StylelintDisableOptionsReport =
      Array<StylelintDisableReportEntry>;
}
